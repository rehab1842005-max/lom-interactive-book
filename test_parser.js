...
console.log('pageQuestions count:', pageQuestions.length);
console.log('zoneQuestions count:', Object.keys(zoneQuestionsMap).length);
console.dir(zoneQuestionsMap, { depth: null });
console.dir(pageQuestions, { depth: null });
